...
namespace DVLD_3Tier.Users
{
    public partial class frmListUsers : Form
    {
        ...
        private void _ResetDefualtValues()
        {
            ...
            //  set the dgvUsers auto size mode columns fill
        }
        ...
        private void txtFilterValue_TextChanged(object sender, EventArgs e)
        {
            ...
            _dtAllUsers.DefaultView.RowFilter = string.Format("CONVERT([{0}], 'System.String') LIKE '{1}%'", FilterColumn, txtFilterValue.Text.Trim());
            else
