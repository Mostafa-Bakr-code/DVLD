...
namespace DVLD_3Tier.People
{
    public partial class FrmListPeople : Form
    {
        ...
        private void txtFilterValue_TextChanged(object sender, EventArgs e)
       {
            ...
            _dtPeople.DefaultView.RowFilter = string.Format("CONVERT([{0}], 'System.String') LIKE '{1}%'", FilterColumn, txtFilterValue.Text.Trim());
            else
        ...
        {
            //we allow only numbers incase person id is selected.
